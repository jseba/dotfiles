...
titlebars.buttons =
    gears.table.join(
    -- Left button: move
    -- (Double tap - Toggle maximize) FIXME: buggy
    awful.button(
        {},
        1,
        function()
    ...
    -- Forward button: toggle floating
    awful.button(
        {},
        9,
        function()
...
playerctl_toggle_icon:buttons(
    gears.table.join(
        ...
        awful.button(
            ...
            9,
            function()
                -- awful.spawn.with_shell("mpv-query")
            end
        )
    )
)
...
client.connect_signal(
    ...
    function(c)
        ...
        if beautiful.titlebars_imitate_borders then
            ...
            -- Custom titlebar for music terminal (ncmpcpp)

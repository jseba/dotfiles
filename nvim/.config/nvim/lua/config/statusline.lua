...
local function set_statusline_bg(item, color)
    vim.api.nvim_set_hl(0, "GalaxyLine" .. item, { bg = M.colors[color] })
end
local function set_statusline_fg(item, color)
    vim.api.nvim_set_hl(0, "GalaxyLine" .. item, { fg = M.colors[color] })
end
local function set_statusline_hi(item, fg, bg)
    vim.api.nvim_set_hl(0, "GalaxyLine" .. item, { fg = M.colors[fg], bg = M.colors[bg] })
end
